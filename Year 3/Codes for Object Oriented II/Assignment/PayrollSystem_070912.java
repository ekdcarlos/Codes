...
public class PayrollSystem {
    ...
    public static void main(String[] args) {
        ...
        // Adding employees
        try {
            payroll.addEmployee(new FullTime("John Smith", "FT001", 5000, 1000));
            payroll.addEmployee(new PartTime("Jane Doe", "PT001", 20, 25));
            payroll.addEmployee(new Intern("Bob Wilson", "IN001", 1000));
            payroll.addEmployee(new FullTime("Alice Brown", "FT002", -100, 500)); // Invalid base pay
            payroll.addEmployee(new PartTime("Tom Clark", "PT002", -10, 20)); // Invalid hours
        } catch (Exception e) {
